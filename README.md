...
2.  **Run the Chatbot:**
    ...
    ```
3.  Access the Streamlit app via your web browser ([typically at `http://localhost:8501`](https://govfundingchatbot-4c5stayhsurtwrvvtfeqwk.streamlit.app/)) to use the chatbot.
